  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        >
          <el-table-column type="selection"  size="mini" align="center" />
          ...
          <el-table-column label="创建时间" align="center" prop="createdAt"  sortable>
            <template slot-scope="scope">
          ...
          <el-table-column  fixed="right" label="操作" align="center" width="220">
              <template slot-scope="scope">				         
                  ...
                  <el-button size="small"  v-if="scope.row.userId !== 1" @click="handleDelete(scope.row)">删除</el-button>
                  <el-button size="small"  @click="handleResetPwd(scope.row)">重置</el-button>	                          
			        </template>
          </el-table-column>  
          <!-- <el-table-column
            label="操作"
