<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" highlight-current-row border size="mini"  @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column  fixed="right" label="操作" align="center" width="250">
        <template slot-scope="scope">				         
            ...
            <el-button size="small"  @click="handleDataScope(scope.row)">数据权限</el-button>
