    ...
    <div class="app-container">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
            <!-- <el-form-item label="" prop="id">
                ...
                <!-- <el-form-item label="对账状态" prop="type">
                ...
                <el-form-item label="" prop="settleDate">
                        <el-input v-model="queryParams.settleDate" placeholder="请输入" clearable size="small" @keyup.enter.native="handleQuery" />
                    </el-form-item> -->
        ...
        <!-- <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button
                        v-permisaction="['tblsumamount:tblsumamount:add']"
                        type="primary"
                        icon="el-icon-plus"
                        size="mini"
                        @click="handleAdd"
            ...
            <el-col :span="1.5">
                <el-button
                        v-permisaction="['tblsumamount:tblsumamount:edit']"
                        type="success"
                        icon="el-icon-edit"
                        size="mini"
                        :disabled="single"
            ...
            <el-col :span="1.5">
                <el-button
                        v-permisaction="['tblsumamount:tblsumamount:remove']"
                        type="danger"
                        icon="el-icon-delete"
                        size="mini"
                        :disabled="multiple"
        ...
        <el-table v-loading="loading" :data="tblsumamountList" size="mini" highlight-current-row border @selection-change="handleSelectionChange">
            ...
            <el-table-column label="币种" align="center" prop="symbol" :show-overflow-tooltip="true" />
             <el-table-column label="历史剩余金额" align="center" prop="historyHistoryAmount" :show-overflow-tooltip="true" />
            <el-table-column label="当日交易金额" align="center" prop="amount" :show-overflow-tooltip="true" />
            <el-table-column label="当日剩余金额" align="center" prop="historyAmount" :show-overflow-tooltip="true" />
            <!-- <el-table-column label="资产编号" align="center" prop="accountId" :show-overflow-tooltip="true" /> -->
            <el-table-column label="对账状态" align="center" prop="type" :formatter="type" />
            <!-- <el-table-column label="结算日期" align="center" prop="settleDate" :show-overflow-tooltip="true" /> -->
            <el-table-column label="结算日期" align="center" prop="settleDate" width="150" sortable>
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="" prop="id">
                    ...
                    <el-form-item label="资产编号" prop="accountId">
                            <el-input v-model="form.accountId" placeholder="资金账户id" />
                        </el-form-item>
                    <el-form-item label="" prop="settleDate">
                            <el-input v-model="form.settleDate" placeholder="" />
                        </el-form-item>
...
<script>
    import { listTblSumAmount, getTblSumAmount, delTblSumAmount, addTblSumAmount, updateTblSumAmount } from '@/api/member/tblSumAmount'
    ...
    export default {
        ...
        data() {
            return {
                ...
                queryParams: {
                    pageIndex: 1,
                    pageSize: 10,id: undefined,memberId: undefined,coinId: undefined,amount: undefined,historyAmount: undefined,accountId: undefined,settleDate: undefined,
        },
            // 表单参数
            form: {},
            // 表单校验
        ...
        methods: {
            ...
            getList() {
                this.loading = true
                listTblSumAmount(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                        this.tblsumamountList = response.data.list
            ...
            handleUpdate(row) {
                ...
                getTblSumAmount(id).then(response => {
                ...
                this.$refs['form'].validate(valid => {
                    if (valid) {
                        if (this.form.id !== undefined) {
                            updateTblSumAmount(this.form).then(response => {
                            ...
                            addTblSumAmount(this.form).then(response => {
                                if (response.code === 200) {
