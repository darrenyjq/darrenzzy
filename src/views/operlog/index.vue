<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list" size="mini" highlight-current-row border   @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed="right"  label="操作" align="center" class-name="small-padding fixed-width" width="100">
        <template slot-scope="scope">
          ...
          >详细</el-button> -->
           <el-button type="primary" plain size="small"  @click="handleView(scope.row,scope.index)">详细</el-button>  
        </template>
      </el-table-column>
    </el-table>
